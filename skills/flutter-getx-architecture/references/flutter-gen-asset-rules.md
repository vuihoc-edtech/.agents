...
2. generate accessors with `flutter_gen`
3. use the generated API in widgets and theme code
4. only fall back to raw paths if a library integration truly requires it
